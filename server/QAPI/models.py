...
class Class(models.Model):
    assigned_responsible = models.ForeignKey(UserProfile, on_delete=models.CASCADE)
...
class Availability(models.Model):
    ...
    is_available = models.BooleanField(default=False)  # True if available, False otherwise

    def __str__(self):
        return f"{self.student.first_name} {self.student.last_name} - {self.day_of_week}: {'Available' if self.is_available else 'Not Available'}"
